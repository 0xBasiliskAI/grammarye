...
Two middleware functions by default which are are located in the `grammarye.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `grammarye.handler` namespace to manage the enabled middleware.
